-- ========================================
-- База данных для 17yotk MC Server
-- ========================================

-- Создание базы данных (если нужно)
-- CREATE DATABASE IF NOT EXISTS a17yotknet_minecraft_site CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE a17yotknet_minecraft_site;

-- ========================================
-- Таблица для привилегий/статусов
-- ========================================
...
-- ========================================
-- Таблица для возможностей привилегий
-- ========================================
CREATE TABLE IF NOT EXISTS privilege_features (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
-- ========================================
-- Таблица для информации о сервере
-- ========================================
...
('features', '["Выживание", "Креатив", "Мини-игры", "Экономика", "Кланы", "Регионы"]', 'Особенности сервера', 'json', TRUE);
